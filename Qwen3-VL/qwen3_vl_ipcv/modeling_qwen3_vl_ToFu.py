...
class Qwen3VLVisionBlock_Sparse(Qwen3VLVisionBlock):
    ...
    def forward(
        ...
        **kwargs,
        ...
        hidden_states_pkg['merged_idx'] = merged_idx
        ...
        for layer_num, blk in enumerate(self.blocks):
            ...
            if IPCV_config is not None and IPCV_config['vit_Sparse']:
                ...
                if layer_num >= K and hidden_states_pkg['hidden_states'].shape[0]>1 and\
                    ...
                    if layer_num - K  < total_prune_layer/2:
                        method = "pruned"
                    else:
                        method = "average"
                    ...
                    hidden_states_pkg = blk(hidden_states_pkg, cu_seqlens=cu_seqlens, position_embeddings=position_embeddings,tome_r=tome_r, method=method, **kwargs)
