...
class Qwen3VLTextModel_Sparse(Qwen3VLTextModel):
    ...
    def forward(
        ...
        **kwargs: Unpack[FlashAttentionKwargs],
        ...
        # # 只触发一次
        # if self.config.IPCV_config is not None and self.config.IPCV_config['Sparse']\
        #     and not self.update_attention_layer:
        ...
        for layer_idx, decoder_layer in enumerate(self.layers):
            ...
            if IPCV_config is not None and IPCV_config['Sparse']:
                ...
                if decoder_layer.self_attn.layer_idx in target_layer_indices and seq_length > 1:
                    ...
                    #print("retained image",retained_image_tokens_index.shape,"keep_indexs",keep_indexs.shape,keep_indexs)
                    # sort index
