...
from Qwen2VL_DART_ViT import load_pretrained_model
...
def configure_DART(model, args):
    ...
    if args.sparse:
        DART_config = {
            ...
            "random_choose":args.random_choose # bool
        }
...
def eval_model(args):
    ...
    tokenizer, model, image_processor, context_len = load_pretrained_model(model_path, args.model_base, model_name,use_flash_attn=True, attn_implementation=args.attn_implementation)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--random_choose', default=False, action='store_true', help='random')
