...
from Qwen2VL_DART_ViT import Qwen2VLForConditionalGeneration,Qwen2VLConfig,Qwen2VLVisionConfig
...
def run_model():
    ...
    vision_config = Qwen2VLVisionConfig.from_pretrained("Qwen/Qwen2-VL-7B-Instruct",DART_config = DART_config)
