...
from Qwen2VL_DART import Qwen2VLForConditionalGeneration,Qwen2VLConfig
...
def run_model():
    ...
    #     attn_implementation="flash_attention_2",DART_config=DART_config
    # )
    model = Qwen2VLForConditionalGeneration.from_pretrained(
    ...
    # pixel_values:[grid_t * grid_h * grid_w  ,  channel * self.temporal_patch_size * self.patch_size * self.patch_size]
    # image_grid_thw [batch_size,thw(3)]
